...
OWNER_ID = int(getenv("OWNER_ID", "5567910560"))
MONGO_URL = getenv("MONGO_URL", None)
SUPPORT_GRP = getenv("SUPPORT_GRP", "t3amn4chat")
UPDATE_CHNL = getenv("UPDATE_CHNL", "n4vpn2")
OWNER_USERNAME = getenv("OWNER_USERNAME", "n4nd404")
